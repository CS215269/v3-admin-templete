...
import { getAuditDataBySearchApi } from "@/api/admin-review"
import { type GetTableThingData } from "@/api/admin-review/types/admin-review"
...
@/api/admin-review/types/admin-review
